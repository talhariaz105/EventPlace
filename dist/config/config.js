...
const envVarsSchema = joi_1.default.object()
    ...
    STRIPE_SECRET_ACCESS_KEY: joi_1.default.string()
        .required()
        .description("Stripe secret key"),
    STRIPE_PUBLISHABLE_KEY: joi_1.default.string()
        .required()
        .description("Stripe publishable key"),
    STRIPE_WEBHOOK_SECRET: joi_1.default.string().description("Stripe webhook secret"),
    STRIPE_REFRESH_URL: joi_1.default.string().description("Stripe refresh URL for onboarding"),
...
const config = {
    ...
    stripe: {
        ...
        refreshUrl: envVars.STRIPE_REFRESH_URL || `${envVars.CLIENT_URL}/stripe/refresh`,
    ...
    google: {
        credentialsPath: envVars.GOOGLE_CREDENTIALS_PATH ||
            path_1.default.join(process.cwd(), "src", "modules", "authjson", "file.json"),
    },
};
